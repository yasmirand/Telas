...
public class Atualiza extends JFrame {
	...
	public Atualiza() {
		...
		txtId.setBounds(44, 204, 135, 20);
		contentPane.add(txtId);
		txtId.setColumns(10);
		
		txtNome = new JTextField();
		txtNome.setBounds(66, 28, 347, 20);
		contentPane.add(txtNome);
		txtNome.setColumns(10);
		
		txtCpf = new JTextField();
		txtCpf.setColumns(10);
		txtCpf.setBounds(56, 62, 357, 20);
		contentPane.add(txtCpf);
		
		txtNasc = new JTextField();
		txtNasc.setColumns(10);
		txtNasc.setBounds(146, 96, 267, 20);
		contentPane.add(txtNasc);
		
		txtCll = new JTextField();
		txtCll.setColumns(10);
		txtCll.setBounds(80, 129, 333, 20);
		contentPane.add(txtCll);
		
		txtEmail = new JTextField();
		txtEmail.setColumns(10);
		txtEmail.setBounds(66, 164, 347, 20);
		...
		btnNewButton_2.setIcon(new ImageIcon("C:\\Users\\Aluno\\eclipse-workspace\\Telas\\src\\imagens\\editar.png"));
